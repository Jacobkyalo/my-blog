...
export const components = {
  ...
  p: (props) => <p className="text-base text-slate-600 my-6" {...props} />,
  ...
  pre: (props) => (
    <pre
      className="bg-black/90 text-white/90 overflow-auto text-xs sm:text-sm w-full bg-opacity-20 rounded-xl p-4 my-8"
      {...props}
    />
  ),
  code: (props) => (
    <code className="text-white w-full rounded-sm p-1" {...props} />
  ),
